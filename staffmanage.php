<?php
    ...
    $sql = "SELECT id, name, pass  FROM login";
...
<form action="add.php" method="post">
                ...
                <div class="container">
                  ...
                  <label for="password2"><b>Re-Enterpassword</b></label>
                  <input type="password" placeholder=" Re-Enter password" name="password2" required>           
                  <button onclick="window.alert('will added soon');" class="butt" type="submit">add user</button>                  
                </div>          
               </form>
               <form action="delete.php" method="post">
               <label for="id"><b>ID</b></label>
                  <input type="text" placeholder="Enter ID to delete" name="id" required>
               <button onclick="window.alert('will be deleted');" class="butt" style="background-color: red;" type="submit">delete user</button> 
               </form>                 
